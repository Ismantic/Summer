...
INLINE_EVAL="bash $SUMMER/inline_eval_progressive.sh {step} $P2_OUT v9_p2_aurora_p1at3000 500"

echo "=== [$(date +%H:%M:%S)] PHASE 2 (Aurora 500) from phase1 step 3000 ==="
cd $SUMMER && $TORCHRUN --nproc_per_node=2 --master_port=29502 finetune_muon.py \
    --model_path $P1_CKPT \
    --train_data $TRAIN_PT \
    --mode clm \
    --output_dir $P2_OUT \
...
bash $SUMMER/eval_full.sh phase2_ckpt_v9_p1step3000_aurora_final
