...
Usage:
    python evals/eval.py --model_path ./HY-MT1.5-1.8B
    python evals/eval.py --model_path ./HY-MT1.5-1.8B-new-tok --max_samples 200
    python evals/eval.py --model_path ./HY-MT1.5-1.8B --no_comet --direction zh-en
"""
import os
import argparse
import time
...
def load_tokenizer(model_path):
    ...
    if os.path.exists(os.path.join(model_path, "piece.model")):
        from core.tokenizer_wrapper import PieceTokenizerWrapper
