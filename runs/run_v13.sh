...
INLINE_EVAL_P1="bash $SUMMER/runs/inline_eval_progressive.sh {step} $V13_P1 v13_p1 8000"
cd $SUMMER && $TORCHRUN --nproc_per_node=2 --master_port=29506 train/finetune_muon.py \
    --model_path $NEW_TOK \
    --train_data $MAIN_PT \
    --mode clm \
    --freeze_transformer \
...
INLINE_EVAL_P2="bash $SUMMER/runs/inline_eval_progressive.sh {step} $V13_P2 v13_p2 2000"
cd $SUMMER && $TORCHRUN --nproc_per_node=2 --master_port=29506 train/finetune_muon.py \
