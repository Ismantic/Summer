...
INLINE_EVAL_P2="bash $SUMMER/runs/inline_eval_vllm.sh {step} $V16_P2 v16_p2 2000"
cd $SUMMER && $TORCHRUN --nproc_per_node=2 --master_port=29516 train/finetune_muon.py \
    --model_path $V15_P1 \
