...
INLINE_EVAL="bash $SUMMER/runs/inline_eval_progressive.sh {step} $V9 v9_p1 11500"
...
INLINE_EVAL_P2="bash $SUMMER/runs/inline_eval_progressive.sh {step} $V9_S2 v9_p2_aurora 500"
