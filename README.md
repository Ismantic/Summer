...
产物是一个 1.5B 参数的 Base 模型,规模上与 GPT-2 XL 相当.
...
(GPT-2 XL 是 48 层 x1600,深而窄).相当于用 2025 年的架构重新分配那笔参数预算.
...
| | 时间 | 从哪开始 | 教程 |
|---|---|---|---|
| 评测模型效果 | 分钟级 | HF 上的 ReTok 模型 | [`docs/eval/pipeline.md`](docs/eval/pipeline.md) |
| 两阶段预训练 | 约 30 小时 + 预编码 | Qwen3-1.7B-Base | [`docs/PRETRAIN.md`](docs/PRETRAIN.md) |
