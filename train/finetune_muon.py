...
Dependencies: torch, transformers (model/tokenizer loading only), core/muon.py (local)
...
from core.muon import SingleDeviceMuonWithAuxAdam
from core.aurora import aurora_update
