...
INLINE_EVAL_P1="bash $SUMMER/inline_eval_progressive.sh {step} $V14_P1 v14_p1 5000"
cd $SUMMER && $TORCHRUN --nproc_per_node=2 --master_port=29507 finetune_muon.py \
    --model_path $NEW_TOK \
    --train_data $MAIN_PT \
    --mode clm \
    --freeze_transformer \
...
INLINE_EVAL_P2="bash $SUMMER/inline_eval_progressive.sh {step} $V14_P2 v14_p2 2000"
cd $SUMMER && $TORCHRUN --nproc_per_node=2 --master_port=29507 finetune_muon.py \
